...
from modules.distribution import Categorical, FiniteDistribution
...
if __name__ == '__main__':
    user_capacity = 2 # C>= On-Hand Inventory at 6pm(alpha) + On-Order Inventory at 6pm(beta)
    user_poisson_lambda = 1 # On-Order Inventory at 6pm-> beta
